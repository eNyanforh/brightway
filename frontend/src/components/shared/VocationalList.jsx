...
const getClassLevelOptions = (baseType, highestEducation) => {
  ...
  // If highest education is doctorate, restrict lower levels (except associate/vocational)
  if (highestEducation === "doctorate") {
    const restrictedOptions = ["Completed", "Graduated"];
    
    return {
      ...baseOptions,
      high: restrictedOptions,
      undergrad: restrictedOptions,
      graduate: restrictedOptions,
      // Associate and vocational keep their full options
      associate: baseOptions.associate,
      vocational: baseOptions.vocational
    };
  }
